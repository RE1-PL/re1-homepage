...
// Hide side buttons on scroll
function handleScroll() {
    const commentElement = document.getElementById("comment");
    const darkModeElement = document.getElementById("darkmode");
    const shouldHide = window.scrollY > 0.01 * window.innerHeight;
    commentElement.style.opacity = darkModeElement.style.opacity = shouldHide ? 0 : 1;
}


// Fetch timeline from html
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('timeline.html?v=' + new Date())
